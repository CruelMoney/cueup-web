...
export const dk: LanguageStrings = {
    /** Routes */
    'routes.home': '/',
    'routes.verifyEmail': '/verifyEmail',
    'routes.blog': '/blog',
    'routes.signup': '/tilmeld',

    /** Page content */
    'home.title': 'Zuhause',
    'home.content': 'Vielen Dank für den Besuch dieses mehrsprachigen Routing-Beispiels.',

    'summary.title': 'Zusammenfassung',
    'summary.content': 'Lesen Sie mehr über den Artikel selbst auf {medium} oder {devto}.',
