...
const IncompleteProfileInformation = ({
    gig,
    loading,
    translate,
    serviceFee,
    ...
    return (
        <GreyBox>
            <TitleClean style={{ marginBottom: '0.5em' }}>Complete your profile</TitleClean>
            <Body>Profiles with pictures and reviews have a higher chance of getting gigs.</Body>
        </GreyBox>
    );
};
